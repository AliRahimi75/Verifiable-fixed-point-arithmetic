...
#         print("Warning: Matrices are not large at least in one dimension!")
    ...
    comm_GKR = comm_GKR + int(math.log2(n)) + int(math.log2(o)) # Sent from Verifier to Prover 
    # -------------------------------------------- Start sumcheck 
    # Verifier and Prover: 
    l = int(math.log2(m)) 
    ...
    if f_renov == 0: 
        print("Done_renov!")           
    return [MLE_v_time_GKR, MLE_p_time_GKR, MLE_v_time, MLE_p_time, prover_time, verifier_time, comm, comm_GKR] 
